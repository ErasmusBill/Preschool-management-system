...
urlpatterns = [
    ...
    # ---------- Classes & Results ----------
    path("list-classes/<int:teacher_id>/", views.list_classes, name="list-classes"),  # ✅ added missing trailing slash
    path("enter-result/<int:subject_id>/", views.enter_results, name="enter-result"),

    # ✅ Add this route if you are redirecting after saving results
    # (the view must exist in views.py)
    path("view-result/<int:subject_id>/", views.view_result, name="view-result"),
]
