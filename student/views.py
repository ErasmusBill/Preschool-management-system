...
def add_student(request):
    ...
    if request.method == 'POST':
        ...
        if not all([
            email, password, repeat_password, first_name, last_name, student_id, gender, date_of_birth,
        ...
        try:
            ...
            try:
                send_mail(subject, message, settings.DEFAULT_FROM_EMAIL, [father_email, mother_email])
