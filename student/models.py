...
class Student(models.Model):
    ...
    fees = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name='students_with_fees'
    )
    ...
    def __str__(self) -> str:
        # Pylance may complain about get_student_class_display() not being recognized
        # This is a known limitation with static analysis tools and Django's dynamic methods
        # The method is automatically generated by Django for fields with choices and will work at runtime
